...
class Kohana_DateTest extends Unittest_TestCase
{
	...
	{
		return array(
			array(30600, 'Asia/Kolkata', 'America/Argentina/Buenos_Aires'),
		);
	}
	...
	public function provider_formatted_time()
	{
		return array(
			...
			// Timezones (see #3902)
			array('2011-04-01 01:23:45 Antarctica/McMurdo', '2011-04-01 01:23:45', 'Y-m-d H:i:s e', 'Antarctica/McMurdo'),
			array('2011-04-01 01:23:45 Antarctica/McMurdo', '2011-03-31 14:23:45 Europe/Paris', 'Y-m-d H:i:s e', 'Antarctica/McMurdo'),
			array('2011-04-01 01:23:45 Antarctica/McMurdo', '@1301574225', 'Y-m-d H:i:s e', 'Antarctica/McMurdo'),
		);
	}
