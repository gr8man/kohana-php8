...
<?php else: ?>
Class is not declared in a file, it is probably an internal <?php echo html::anchor('http://php.net/manual/class.'.strtolower((string) $doc->class->name).'.php', 'PHP class') ?>.
<?php endif ?>
</p>
