 ...
 */
class Kohana_ORM extends Model implements \Stringable
{
	/**
	...
	protected function _initialize()
	{
		...
		if (empty($this->_object_name)) {
			$this->_object_name = strtolower(substr(static::class, 6));
		}
	 ...
	 * @return ORM
	 */
	public function values(array $values, array $expected = null): static
	{
	...
	protected function _load_result($multiple = false)
	{
		...
		if ($multiple === true) {
			...
			$result = $this->_db_builder->as_object(static::class)->execute($this->_db);
	...
	protected function _load_values(array $values): static
	{
		...
		foreach ($values as $column => $value) {
			if (!str_contains((string) $column, ':')) {
				...
				[$prefix, $column] = explode(':', (string) $column, 2);
	 ...
	 * @return ORM
	 */
	public function check(Validation $extra_validation = null): static
	{
	 ...
	 * @return ORM
	 */
	public function save(Validation $validation = null): static
	{
	 ...
	 */
	public function has($alias, $far_keys = null): bool
	{
	 ...
	 * @param  mixed   $far_keys Related model, primary key, or an array of primary keys
	 */
	public function has_any($alias, $far_keys = null): bool
	{
	 ...
	 * @return ORM
	 */
	public function add($alias, $far_keys): static
	{
		$far_keys = ($far_keys instanceof ORM) ? $far_keys->pk() : $far_keys;
	 ...
	 * @return ORM
	 */
	public function remove($alias, $far_keys = null): static
	{
		$far_keys = ($far_keys instanceof ORM) ? $far_keys->pk() : $far_keys;
	...
	protected function _unserialize_value($value): mixed
	{
	 ...
	 */
	public function unique($field, $value): bool
	{
