 ...
 */
abstract class Kohana_Database implements \Stringable
{
	// Query types
	 ...
	 */
	public function __construct(protected $_instance, array $config)
	{
	 ...
	 * @param false $as_object result object class string, TRUE for stdClass, FALSE for assoc array
