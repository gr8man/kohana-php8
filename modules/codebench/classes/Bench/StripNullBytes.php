...
class Bench_StripNullBytes extends Codebench
{
	...
	public function bench_str_replace($subject): string|array
	{
	...
	public function bench_preg_replace($subject): string|array|null
	{
		return preg_replace('~\0+~', '', (string) $subject);
	}
